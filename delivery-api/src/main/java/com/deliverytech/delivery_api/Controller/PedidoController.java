...
public class PedidoController {
    ...
    criarPedido(@RequestParam Long clienteId, @RequestParam Long restauranteId) { 
        try { 
    ...
    adicionarItem(@PathVariable Long pedidoId, @RequestParam Long produtoId, @RequestParam Integer quantidade) { 
        try { 
    ...
    confirmarPedido(@PathVariable Long pedidoId) { 
        try { 
    ...
    public ResponseEntity<List<Pedido>>

    listarPorCliente(@PathVariable Long clienteId) { 
    ...
    buscarPorNumero(@PathVariable String numeroPedido) { 
    ...
    cancelarPedido(@PathVariable Long pedidoId, @RequestParam(required = false) String motivo) { 
        try { 
